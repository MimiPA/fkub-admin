...
const columns = [
    ...
    {
        name: "Tempat Ibadah",
        selector: (row) => row.Pengajuan.tempat_ibadah,
        sortable: true,
    },
    {
...
export default function ListSuratKRK() {
    const [data, setData] = useState([]);

    useEffect(() => {
        api.get('/suratKRK/pmptsp/list').then(res => {
    ...
    const filteredItems = data.filter(item =>
        ...
        item.Pengajuan.status && item.Pengajuan.status.toLowerCase().includes(filterText.toLowerCase())
    );
