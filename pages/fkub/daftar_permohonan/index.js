...
import ListPermohonan from "../../../src/views/fkub/listPermohonan";
...
export default function ListPengajuanPermohonan() {
    return (
        <>
                    ...
                    <main>
                        <div className="bg-[#E5E5E5] min-h-screen px-5 pt-5 ">
                            <div className="pl-5 mb-5">
                                ...
                                <Link href="/fkub/daftar_permohonan">
                                    <span className="text-gray-400"> Daftar Permohonan</span>
                                </Link>
                            </div>
